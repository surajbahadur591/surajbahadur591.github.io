 ...
 *
 */
!function(e){e.fn.socialstream=function(a){var t={socialnetwork:"flickr",username:"pixel-industry",limit:6,overlay:!0,apikey:!1},a=e.extend(t,a);return this.each(function(){function t(t){e.get("http://www.googleapis.com/youtube/v3/playlistItems",{part:"snippet",maxResults:a.limit,playlistId:t,key:a.apikey},function(t){var r='<ul class="youtube-list">';e.each(t.items,function(t,i){var s=i.snippet.thumbnails["default"].url,l="";if(!s)return!1;var n=(e("<div></div>"),"http://www.youtube.com/watch?v="+i.snippet.resourceId.videoId),c=i.snippet.title;if(a.overlay)var l='<div class="img-overlay"></div>';r+='<li><a target="_blank" href="'+n+'" title="'+c+'"><img src="'+s+'"/>'+l+"</a></li>"}),r+="</ul>",e(i).append(r)})}var i=e(this);switch(a.socialnetwork){case"flickr":i.append('<ul class="flickr-list"></ul>'),e.getJSON("http://api.flickr.com/services/rest/?method=flickr.people.findByUsername&username="+a.username+"&format=json&api_key=32ff8e5ef78ef2f44e6a1be3dbcf0617&jsoncallback=?",function(t){var r=t.user.nsid;e.getJSON("http://api.flickr.com/services/rest/?method=flickr.photos.search&user_id="+r+"&format=json&api_key=85145f20ba1864d8ff559a3971a0a033&per_page="+a.limit+"&page=1&extras=url_sq&jsoncallback=?",function(t){e.each(t.photos.photo,function(t,r){var s=r.owner,l=r.title,n=r.url_sq,c=r.id,o="http://www.flickr.com/photos/"+s+"/"+c,p=e("<img/>").attr({src:n,alt:l}),d=e("<a/>").attr({href:o,target:"_blank",title:l}),u=e(d).append(p);if(a.overlay){var v=e("<div/>").addClass("img-overlay");e(d).append(v)}var f=e("<li/>").append(u);e("ul",i).append(f)})})});break;case"pinterest":var r="http://pinterest.com/"+a.username+"/feed.rss",s="http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&callback=?&q="+encodeURIComponent(r)+"&num="+a.limit+"&output=json_xml";e.getJSON(s,function(t){if(200==t.responseStatus){var r=t.responseData.feed,s="";if(!r)return!1;for(var l='<ul class="pinterest-list">',n=0;n<r.entries.length;n++){var c=r.entries[n],o=e("<div></div>");o.append(c.content);var p="http://www.pinterest.com"+o.find("a").attr("href"),d=o.find("img").attr("src"),u=o.find("p:nth-child(2)").html();if(a.overlay)var s='<div class="img-overlay"></div>';l+='<li><a target="_blank" href="'+p+'" title="'+u+'"><img src="'+d+'"/>'+s+"</a></li>"}l+="</ul>",e(i).append(l)}});break;case"instagram":i.append('<ul class="instagram-list"></ul>');var l="200718541.a4734ab.cc050fa16d6141bf8b709c97ab158f57";r="http://api.instagram.com/v1/users/search?q="+a.username+"&access_token="+l+"&count=1&callback=?",e.getJSON(r,function(t){e.each(t.data,function(t,s){var n=s.username;if(n==a.username){var c=s.id;""!=c&&(r="http://api.instagram.com/v1/users/"+c+"/media/recent/?access_token="+l+"&count="+a.limit+"&callback=?",e.getJSON(r,function(t){e.each(t.data,function(t,r){var s=r.images.thumbnail.url,l=r.link,n="";null!=r.caption&&(n=r.caption.text);var c=e("<img/>").attr({src:s,alt:n}),o=e("<a/>").attr({href:l,target:"_blank",title:n}),p=e(o).append(c);if(a.overlay){var d=e("<div/>").addClass("img-overlay");e(o).append(d)}var u=e("<li/>").append(p);e("ul",i).append(u)})}))}})});break;case"dribbble":i.append('<ul class="dribbble-list"></ul>'),e.getJSON("http://dribbble.com/"+a.username+"/shots.json?callback=?",function(t){e.each(t.shots,function(t,r){if(t<a.limit){var s=r.title,l=e("<img/>").attr({src:r.image_teaser_url,alt:s}),n=e("<a/>").attr({href:r.url,target:"_blank",title:s}),c=e(n).append(l);if(a.overlay){var o=e("<div/>").addClass("img-overlay");e(n).append(o)}var p=e("<li/>").append(c);e("ul",i).append(p)}})});break;case"deviantart":var r="http://backend.deviantart.com/rss.xml?type=deviation&q=by%3A"+a.username+"+sort%3Atime+meta%3Aall",s="http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&callback=?&q="+encodeURIComponent(r)+"&num="+a.limit+"&output=json_xml";e.getJSON(s,function(t){if(200==t.responseStatus){var r=t.responseData.feed,s="";if(!r)return!1;for(var l='<ul class="deviantart-list">',n=0;n<r.entries.length;n++){var c=r.entries[n],o=e("<div></div>");o.append(c.content);var p=c.link,d=o.find("img").attr("src");if(!(d.indexOf("smile.gif")>=0)){var u=c.title.replace(/.jpg/g,"").replace(/-/g," ").replace(/_/g," ");if(a.overlay)var s='<div class="img-overlay"></div>';l+='<li><a target="_blank" href="'+p+'" title="'+u+'"><img src="'+d+'"/>'+s+"</a></li>"}}l+="</ul>",e(i).append(l)}});break;case"picasa":var r="http://picasaweb.google.com/data/feed/base/user/"+a.username+"?alt=rss&kind=photo&hl=en_US&imgmax="+a.limit+"&thumbsize=48c",s="http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&callback=?&q="+encodeURIComponent(r)+"&num="+a.limit+"&output=json_xml";e.getJSON(s,function(t){if(200==t.responseStatus){var r=t.responseData.feed,s="";if(!r)return!1;for(var l='<ul class="picasa-list">',n=0;n<r.entries.length;n++){var c=r.entries[n],o=e("<div></div>");o.append(c.content);var p=c.link,d=o.find("img").attr("src"),u=c.title.replace(/.jpg/g,"").replace(/-/g," ").replace(/_/g," ");if(a.overlay)var s='<div class="img-overlay"></div>';l+='<li><a target="_blank" href="'+p+'" title="'+u+'"><img src="'+d+'"/>'+s+"</a></li>"}l+="</ul>",e(i).append(l)}});break;case"youtube":var n;a.apikey&&e.get("http://www.googleapis.com/youtube/v3/channels",{part:"contentDetails",forUsername:a.username,key:a.apikey},function(a){e.each(a.items,function(e,a){n=a.contentDetails.relatedPlaylists.uploads,t(n)})});break;case"newsfeed":var s="http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&callback=?&q="+encodeURIComponent(a.username)+"&num="+a.limit+"&output=json_xml";e.getJSON(s,function(t){if(200==t.responseStatus){var r=t.responseData.feed,s="";if(!r)return!1;for(var l='<ul class="social-feed">',n=0;n<r.entries.length;n++){var c=r.entries[n],o=e("<div></div>");o.append(c.content);var p=c.link,d=o.find("img").attr("src"),u=c.title.replace(/.jpg/g,"").replace(/-/g," ").replace(/_/g," ");if(a.overlay)var s='<div class="img-overlay"></div>';l+='<li><a target="_blank" href="'+p+'" title="'+u+'"><img src="'+d+'"/>'+s+"</a></li>"}l+="</ul>",e(i).append(l)}})}})}}(jQuery);
/*!
 *
...
(function($){"use strict";var $masonry_container;$(function(){if($(".intro figure").length){$(".intro figure").eq(0).before('<div class="figure-boxes"></div>');$('.intro figure').each(function(index,element){$(this).wrap('<div class="figure-box"></div>');$(this).find('a').css('background-image','url('+$(this).find('img').attr('src')+')');$(this).append('<a class="figure-link" href="'+$(this).find('a').attr('href')+'"></a>')});$('.intro .figure-box').appendTo('.figure-boxes')}
var $menu=$('.nav-menu');$menu.find('li').each(function(index,element){if($(this).children('ul').length){$(this).addClass('has-submenu');$(this).find('>a').after('<span class="submenu-toggle"></span>')}});var $submenuTrigger=$('.has-submenu > .submenu-toggle');$submenuTrigger.on("click",function(){$(this).parent().toggleClass('active');$(this).siblings('ul').toggleClass('active')});var $intro_h=$('.intro h3');$intro_h.append('<span class="words-wrapper"></span>');$intro_h.find('strong').appendTo('.words-wrapper');$intro_h.find('strong').eq(0).addClass('is-visible');var rotate_classes='rotate-title '+$('.intro').data('animation');$intro_h.addClass(rotate_classes);var animationDelay=2500,barAnimationDelay=3800,barWaiting=barAnimationDelay-3000,lettersDelay=50,typeLettersDelay=150,selectionDuration=500,typeAnimationDelay=selectionDuration+800,revealDuration=600,revealAnimationDelay=1500;initHeadline();function initHeadline(){singleLetters($('.rotate-title.letters').find('strong'));animateHeadline($('.intro h3'))}
...
spanWrapper.css('width',newWidth)}else if(!headline.hasClass('type')){var words=headline.find('.words-wrapper strong'),width=0;words.each(function(){var wordWidth=$(this).width();if(wordWidth>width)width=wordWidth});headline.find('.words-wrapper').css('width',width)};setTimeout(function(){hideWord(headline.find('.is-visible').eq(0))},duration)})}
function hideWord($word){var nextWord=takeNext($word);if($word.parents('.rotate-title').hasClass('type')){var parentSpan=$word.parent('.words-wrapper');parentSpan.addClass('selected').removeClass('waiting');setTimeout(function(){parentSpan.removeClass('selected');$word.removeClass('is-visible').addClass('is-hidden').children('i').removeClass('in').addClass('out')},selectionDuration);setTimeout(function(){showWord(nextWord,typeLettersDelay)},typeAnimationDelay)}else if($word.parents('.rotate-title').hasClass('letters')){var bool=($word.children('i').length>=nextWord.children('i').length)?!0:!1;hideLetter($word.find('i').eq(0),$word,bool,lettersDelay);showLetter(nextWord.find('i').eq(0),nextWord,bool,lettersDelay)}else if($word.parents('.rotate-title').hasClass('clip')){$word.parents('.words-wrapper').animate({width:'2px'},revealDuration,function(){switchWord($word,nextWord);showWord(nextWord)})}else if($word.parents('.rotate-title').hasClass('loading-bar')){$word.parents('.words-wrapper').removeClass('is-loading');switchWord($word,nextWord);setTimeout(function(){hideWord(nextWord)},barAnimationDelay);setTimeout(function(){$word.parents('.words-wrapper').addClass('is-loading')},barWaiting)}else{switchWord($word,nextWord);setTimeout(function(){hideWord(nextWord)},animationDelay)}}
function showWord($word,$duration){if($word.parents('.rotate-title').hasClass('type')){showLetter($word.find('i').eq(0),$word,!1,$duration);$word.addClass('is-visible').removeClass('is-hidden')}else if($word.parents('.rotate-title').hasClass('clip')){$word.parents('.words-wrapper').animate({'width':$word.width()+10},revealDuration,function(){setTimeout(function(){hideWord($word)},revealAnimationDelay)})}}
function hideLetter($letter,$word,$bool,$duration){$letter.removeClass('in').addClass('out');if(!$letter.is(':last-child')){setTimeout(function(){hideLetter($letter.next(),$word,$bool,$duration)},$duration)}else if($bool){setTimeout(function(){hideWord(takeNext($word))},animationDelay)}
if($letter.is(':last-child')&&$('html').hasClass('no-csstransitions')){var nextWord=takeNext($word);switchWord($word,nextWord)}}
function showLetter($letter,$word,$bool,$duration){$letter.addClass('in').removeClass('out');if(!$letter.is(':last-child')){setTimeout(function(){showLetter($letter.next(),$word,$bool,$duration)},$duration)}else{if($word.parents('.rotate-title').hasClass('type')){setTimeout(function(){$word.parents('.words-wrapper').addClass('waiting')},200)}
if(!$bool){setTimeout(function(){hideWord($word)},animationDelay)}}}
function takeNext($word){return(!$word.is(':last-child'))?$word.next():$word.parent().children().eq(0)}
function takePrev($word){return(!$word.is(':first-child'))?$word.prev():$word.parent().children().last()}
function switchWord($oldWord,$newWord){$oldWord.removeClass('is-visible').addClass('is-hidden');$newWord.removeClass('is-hidden').addClass('is-visible')}
blogMinLayout();setPostTypes('.img-vertical');setPostTypes('.img-square');setPostTypes('.img-horizontal');function blogMinLayout(){$('.blog-irregular img').each(function(index,element){var $img=$(this);var ratio=$img.attr('width')/$img.attr('height');var ratio_class="";if((ratio<1.33)&(ratio>0.8)){ratio_class='img-square'}else if(ratio<0.8){ratio_class='img-vertical'}else if(ratio>1.33){ratio_class='img-horizontal'}
$img.parents('.hentry').addClass(ratio_class)})}
function setPostTypes(el){$(el).each(function(index,element){var mod=index%2;$(this).addClass('type-'+mod)})}
if(!($('.header-small .post-slider, .header-small .featured-top, .header-small .blog-bold, .header-small .blog-waterfall, .blog-creative.first-full').length)){$('html').addClass('has-menu-border')}
$("body").fitVids({customSelector:'iframe[src*="facebook.com/plugins/video"], iframe[src*="facebook.com/video/embed"]'});$('iframe[src*="soundcloud.com"]').wrap('<div class="fluid-audio fluid-width-video-wrapper"></div>');$('.fluid-width-video-wrapper').wrap('<div class="media-wrap"></div>');$('.entry-content > p a, .wp-caption a').each(function(index,element){if($(this).attr('href').match(/\.(jpeg|jpg|gif|png)$/)!=null){$(this).fluidbox()}});collage();var resizeTimer=null;$(window).bind('resize',function(){$('.gallery figure').css("opacity",0);if(resizeTimer)clearTimeout(resizeTimer);resizeTimer=setTimeout(collage,1200);collage()});if($(".lightbox, .gallery.link-to-file").length){$('.media-box, .gallery.link-to-file').each(function(index,element){var $media_box=$(this);$media_box.magnificPopup({delegate:'.lightbox, .gallery-item a',type:'image',image:{markup:'<div class="mfp-figure">'+'<div class="mfp-close"></div>'+'<div class="mfp-img"></div>'+'</div>'+'<div class="mfp-bottom-bar">'+'<div class="mfp-title"></div>'+'<div class="mfp-counter"></div>'+'</div>',cursor:'mfp-zoom-out-cur',verticalFit:!0,tError:'<a href="%url%">The image</a> could not be loaded.'},gallery:{enabled:!0,tCounter:'<span class="mfp-counter">%curr% / %total%</span>'},iframe:{markup:'<div class="mfp-iframe-scaler">'+'<div class="mfp-close"></div>'+'<iframe class="mfp-iframe" frameborder="0" allowfullscreen></iframe>'+'<div class="mfp-title">Some caption</div>'+'</div>'},mainClass:'mfp-zoom-in',tLoading:'',removalDelay:300,callbacks:{markupParse:function(template,values,item){var title="";if(item.el.parents('.gallery-item').length){title=item.el.parents('.gallery-item').find('.gallery-caption').text()}else{title=item.el.attr('title')==undefined?"":item.el.attr('title')}
...
var owl=$('.owl-carousel');if(owl.length){owl.each(function(index,element){$(element).imagesLoaded(function(){$(element).find('.loading').remove();var items=$(element).data('items');if(items===1){$(element).addClass('single-slide')}else if(items===2){$(element).addClass('two-slides')}
$(element).owlCarousel({loop:$(element).data('loop'),center:$(element).data('center'),mouseDrag:$(element).data('mouse-drag'),dots:$(element).data('dots'),nav:$(element).data('nav'),autoplay:$(element).data('autoplay'),autoplaySpeed:$(element).data('autoplay-speed'),autoplayTimeout:$(element).data('autoplay-timeout'),autoplayHoverPause:!0,navText:[],autoHeight:$(element).hasClass('post-slider')?!1:!0,responsive:{0:{items:1},768:{items:items<=2?items:2},1200:{items:items<=3?items:3},1600:{items:items}},onInitialized:animate_blog})})})}
...
$('.search-toggle').on('click',function(event){showHideNav();event.preventDefault()});function showHideNav(){if($html.hasClass('menu-expanded')){hideNav()}else{showNav()}}
...
$('body').keydown(function(e){if(e.keyCode===27){showHideNav();e.preventDefault()}});$('.menu-toggle').on("click",function(e){e.stopPropagation();$('html').toggleClass('is-menu-toggled-on')});var socialFeed=$('.social-feed');if(socialFeed.length){socialFeed.each(function(){$(this).socialstream({socialnetwork:$(this).data("social-network"),limit:$(this).data("limit"),username:$(this).data("username")})})}
if($('.is-selection-shareable').length){$('.single-post .entry-content p, .single-post .entry-content blockquote').selectionSharer()}
FastClick.attach(document.body);$('#commentform, .mc4wp-form form').addClass('validate-form');$('#commentform').find('input,textarea').each(function(index,element){if($(this).attr('aria-required')==="true"){$(this).addClass('required')}
if($(this).attr('name')=="email"){$(this).addClass('email')}});if($('.validate-form').length){$('.validate-form').each(function(){$(this).validate()})}
$masonry_container=$('.masonry');if($masonry_container.length){$masonry_container.imagesLoaded(function(){$masonry_container.width($masonry_container.parent().width());$masonry_container.isotope({itemSelector:'.hentry',layoutMode:$masonry_container.data('layout'),transitionDuration:0});setMasonry();setTimeout(function(){$masonry_container.isotope()},20);$(window).resize(function(){$masonry_container.width($masonry_container.parent().width());setMasonry()})})}});window.onload=function(){collage();animate_blog()};function animate_blog(){var items=$('.blog-animated .blog-stream .hentry');var items_in_viewport=$('.blog-animated .blog-stream .hentry:in-viewport');var effect=$('html').data('effect');items.addClass('animated out');items_in_viewport.removeClass('animated out');items.each(function(index,element){var el=$(element);el.waypoint(function(){el.addClass(effect).removeClass('out')},{offset:'75%'})})}
function collage(){var collage=$('.gallery');if(collage.length){collage.each(function(index,el){$(el).imagesLoaded(function(){$(el).addClass('collage-loaded');$(el).collagePlus({'targetHeight':320,'effect':'effect-2','allowPartialLastRow':!1})})})}}
function setMasonry(){var itemW=$masonry_container.data('item-width');var mobileItemW=$masonry_container.data('mobile-item-width');var containerW=$masonry_container.width();itemW=containerW>680?itemW:mobileItemW;var items=$masonry_container.children('.hentry');var columns=Math.round(containerW/itemW);if(containerW>680&containerW<940){$masonry_container.removeClass('desktop-view').addClass('tablet-view')}else if(containerW>940){$masonry_container.addClass('desktop-view')}else{$masonry_container.removeClass('desktop-view tablet-view')}
items.each(function(index,element){var multiplier=$(this).hasClass('x2')&&columns>1?2:1;var itemRealWidth=(Math.floor(containerW/columns)*100/containerW)*multiplier;if($masonry_container.hasClass('first-full')&&index==0){itemRealWidth=100}
$(this).css('width',itemRealWidth+'%')});var columnWidth=Math.floor(containerW/columns);$masonry_container.isotope('option',{masonry:{columnWidth:columnWidth}})}})(jQuery);
